...
public class LabExer5B {
    public static void main(String[] args) {
        String[][] questions = {
               ...
               {"Pogi ba si sir Motol?", "A. Oo", "B. Hindi", "C. Medyo", "A",}, //Question 1
               {"Single ba si sir Motol?", "A. Oo", "B. Taken", "C. Complicated", "B"}, //Question 2
               {"Cute ba si sir Motol?", "A. Oo", "B. Sometimes", "C. No way", "B"}, //Question 3
               {"Magaling ba mag turo si sir Motol?", "A. Oo", "B. Hindi", "C. Magaling", "C"},  //Question 4
               {"Best prof ba si sir Motol?", "A. Oo", "B. Hindi", "C. Syempre", "C"}, //Question 5
               {"Miss mo na ba siya?", "A. Oo", "B. Hindi", "C. Hindi na ako aasa", "C"}, //Question 6
               {"Gusto mo pa ba siya?", "A. Oo", "B. Hindi", "C. Ayaw ko na sakaniya", "C"}, //Question 7
               {"Gusto mo ba siya makita?", "A. Oo", "B. Hindi", "C. Please ayaw ko na", "B"}, //Question 8
               {"Sure ka mahal mo pa siya?", "A. Oo", "B. Hindi", "C. It's complicated", "C"}, //Question 9
               {"Aamin ka ba sakaniya?", "A. Oo", "B. Hindi", "C. Ititigil ko na pagiging delulu ko", "A"} //Question 10
        };
