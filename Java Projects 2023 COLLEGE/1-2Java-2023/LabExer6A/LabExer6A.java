...
public class LabExer6A {
    ...
    public static void main(String[] args) {
        ...
        while (continuePlaying) {
            Path filePath = Paths.get("F:\\PROJECT CODES\\ProgrammingRelated\\LabExer6A\\words.txt");
            filePath("words.txt"); // Call the filePath() method here
    ...
    private static void filePath(String fileName) {
